	...
	<div class="asset-abstract">
		...
		<div class="asset-content">
			...
			<div class="asset-summary">
				...
				<a href="${viewURL}">${liferayMacro.language("read-more")}<span class="hide-accessible">${liferayMacro.language("about")}${entryTitle}</span> &raquo;</a>
			</div>
...
>
	<#if stringUtil.split(metadataFields)?seq_contains(fieldName)>
		<span class="metadata-entry metadata-"${fieldName}">
			...
			<#if fieldName == "author">
				${liferayMacro.language("by")} ${portalUtil.getUserName(assetRenderer.getUserId(), assetRenderer.getUserName())}
			...
			<#elseif fieldName == "view-count">
				...
				${entry.getViewCount()} ${liferayMacro.language("views")}
			</#if>
		</span>
	</#if>
</#macro>
