...
if (!themeDisplay.isStatePopUp()) {
	AUI().ready('aui-io-request', 'aui-live-search', 'aui-overlay-context-panel', 'aui-viewport', 'event-mouseenter', 'liferay-message', 'liferay-panel', 'liferay-store', 'node-focusmanager', 'transition',
		function(A) {
			var body = A.getBody();
			var win = A.getWin();
			...
			var ControlPanel = {
				...
				_createCancelButton: function() {
					...
					cancelSearch.on('click',instance._clearSearch, instance);

					toggleNavigationLink.on('click', instance._clearSearch, instance);
				},
