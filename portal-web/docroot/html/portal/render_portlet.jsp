...
%>
		...
		<aui:script position="inline" use="aui-base">
			if (window.parent) {
				...
				<c:choose>
					<c:when test='<%= (portletResourcePortlet != null && !portletResourcePortlet.isAjaxable()) || SessionMessages.contains(renderRequestImpl, portletConfig.getPortletName() + ".notAjaxable") %>'>
