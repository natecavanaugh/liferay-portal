...
<aui:form action='<%= themeDisplay.getPathMain() + "/portal/update_terms_of_use" %>' name="fm">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<ol>
				<li>
					<strong><span class="emphasized">Acceptance of Agreement</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Copyright</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Service Marks</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Limited Right to Use</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Editing, Deleting and Modification</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Indemnification</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Nontransferable</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Disclaimer and Limits</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Use of Information asdf</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Third-Party Services</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Third-Party Merchant Policies</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Privacy Policy</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Payments</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Securities Laws</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Links to Other Web Sites</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Copyrights and Copyright Agents</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Proposed Product and Service Offerings</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Information and Press Releases</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasized">Miscellaneous</span></strong>.<br />
