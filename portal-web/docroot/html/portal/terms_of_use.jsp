...
<aui:form action='<%= themeDisplay.getPathMain() + "/portal/update_terms_of_use" %>' name="fm">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<ol>
				<li>
					<strong><span class="emphasis">Acceptance of Agreement</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Copyright</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Service Marks</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Limited Right to Use</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Editing, Deleting and Modification</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Indemnification</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Nontransferable</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Disclaimer and Limits</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Use of Information asdf</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Third-Party Services</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Third-Party Merchant Policies</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Privacy Policy</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Payments</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Securities Laws</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Links to Other Web Sites</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Copyrights and Copyright Agents</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Proposed Product and Service Offerings</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Information and Press Releases</span></strong>.<br />
				...
				<li>
					<strong><span class="emphasis">Miscellaneous</span></strong>.<br />
