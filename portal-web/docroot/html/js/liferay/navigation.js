				...
				prototype: {
					...
					initializer: function(config) {
						...
						if (navBlock) {
							...
							Navigation._makeSortable();
							instance._makeEditable();

							instance.on('savePage', Navigation._savePage);
					...
					_makeDeletable: function() {
						...
						if (instance.get('isModifiable')) {
							...
							navBlock.delegate(
								['click', 'touchstart'],
								A.bind(Navigation._removePage, instance),
								'.delete-tab'
							);
				...
				if (instance.get('isSortable')) {
					...
					sortable.delegate.on(
						...
						function(event) {
							...
							Navigation._saveSortables(dragNode);
