	...
	<div class="portrait">
		<c:choose>
			<c:when test="<%= message.isAnonymous() || (userDisplay == null) %>">
				<img alt="<liferay-ui:message key="generic-portrait" />" class="avatar" src="<%= UserConstants.getPortraitURL(themeDisplay.getPathImage(), true, 0, StringPool.BLANK) %>" width="60" /></a>
			</c:when>
			<c:otherwise>
