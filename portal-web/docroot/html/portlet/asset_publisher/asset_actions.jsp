...
<c:if test="<%= editPortletURL != null %>">
	<div class="lfr-meta-actions asset-actions">
		...
		<%
		String taglibEditURL = "javascript:Liferay.Util.openWindow({dialog: {width: 960, centered: true}, id: '" + renderResponse.getNamespace() + "editAsset', title: '" + LanguageUtil.format(pageContext, "edit-x", HtmlUtil.escape(assetRenderer.getTitle(locale))) + "', uri:'" + HtmlUtil.escapeURL(editPortletURL.toString()) + "'});";
		%>
