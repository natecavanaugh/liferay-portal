				...
				<aui:fieldset label="asset-entry-type">
					...
					%>
						...
						<div class='asset-subtype <%= (assetSelectedClassTypeIds.length < 1) ? StringPool.BLANK : "aui-hide" %>' id="<portlet:namespace /><%= className %>Options">
							...
							<div class="asset-subtypefields-wrapper-enable aui-hide" id="<portlet:namespace />subtypeFieldsFilterEnableWrapper">
							...
							<div class="asset-subtypefields-wrapper aui-hide" id="<portlet:namespace />subtypeFieldsWrapper">
