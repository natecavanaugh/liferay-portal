...
<aui:form action="<%= searchURL %>" method="get" name="fm" onSubmit="event.preventDefault();">
	...
	<aui:fieldset cssClass="lfr-search" id="searchContainer">
		...
		<aui:input alt='<%= LanguageUtil.get(pageContext, "clear-search") %>' inlineField="<%= true %>" label="" name="clearSearch" src='<%= themeDisplay.getPathThemeImages() + "/common/close.png" %>' title="clear-search" type="image" />
	</aui:fieldset>
