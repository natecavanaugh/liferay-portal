					...
					<td align="right" class="table-cell">
						<div class="control">
							<c:if test="<%= ldapServerIds.length > 1 %>">
								...
								<%
								String taglibUpURL = "javascript:" + renderResponse.getNamespace() + "changeLDAPServerPriority(" + ldapServerId + ", 'prev');";
								%>
								...
								<%
								String taglibDownURL = "javascript:" + renderResponse.getNamespace() + "changeLDAPServerPriority(" + ldapServerId + ", 'next');";
								%>
