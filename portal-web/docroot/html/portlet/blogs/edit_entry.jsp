			...
			<div class="<%= (entry != null) ? "entry-status " + WorkflowConstants.getStatusLabel(entry.getStatus()) : StringPool.BLANK %>">
				...
				<liferay-ui:section>
					...
					<div class="entry-title">
						<h2><liferay-ui:input-editor contents="<%= title %>" data="<%= dataTextEditor %>" editorImpl="<%= EDITOR_IMPL_KEY %>" name="title" placeholder="title" /></h2>
					</div>

					<aui:input name="title" type="hidden" />

					<div class="entry-subtitle">
						<liferay-ui:input-editor contents="<%= subtitle %>" data="<%= dataTextEditor %>" editorImpl="<%= EDITOR_IMPL_KEY %>" name="subtitle" placeholder="subtitle" />
					</div>
					...
					<div class="entry-body">
						...
						<liferay-ui:input-editor contents="<%= content %>" data="<%= data %>" editorImpl="<%= EDITOR_IMPL_KEY %>" name="content" onChangeMethod="OnChangeEditor" placeholder="content" />
					</div>
					...
					<div class="entry-abstract-wrapper">
						...
						<aui:fieldset cssClass="entry-abstract">
							...
							<div class="entry-description">
								<liferay-ui:input-editor contents="<%= description %>" cssClass='<%= customAbstract ? StringPool.BLANK : "readonly" %>' data="<%= dataTextEditor %>" editorImpl="<%= EDITOR_IMPL_KEY %>" name="description" onInitMethod="OnDescriptionEditorInit" placeholder="description" />
							</div>
