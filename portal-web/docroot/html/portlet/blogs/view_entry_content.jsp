		...
		<div class="entry <%= WorkflowConstants.getStatusLabel(entry.getStatus()) %>" id="<portlet:namespace /><%= entry.getEntryId() %>">
			<div class="entry-content">
				...
				%>
					...
					<img alt="<liferay-ui:message escapeAttribute="<%= true %>" key="cover-image" />" class="cover-image" src="<%= PortletFileRepositoryUtil.getPortletFileEntryURL(themeDisplay, coverImage, StringPool.BLANK) %>" />
