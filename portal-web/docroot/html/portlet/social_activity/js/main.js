		...
		var SettingsDisplay = A.Component.create(
			{
				...
				prototype: {
					...
					renderUI: function() {
						...
						var activityDefinitionsLanguageKeys = originalConfig.activityDefinitionsLanguageKeys;
						...
						A.each(
							...
							function(item, index, collection) {
								item.localizedName = activityDefinitionsLanguageKeys[item.modelName + '.' + item.languageKey];
						...
						var limitNode = TPL_FIELD.render(
							{
								...
								fourthText: Lang.sub(Liferay.Language.get('social-activity-setting-fourthtext'), [TPL_CONTRIBUTION_INCREMENT])
							}
						);
