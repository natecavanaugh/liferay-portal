	...
	<aui:fieldset>
		<c:choose>
			...
			<c:when test="<%= (role == null) %>">
				<aui:field-wrapper label="type" name="roleType">
					<liferay-ui:input-resource id="roleType" url="<%= LanguageUtil.get(pageContext, RoleConstants.getTypeLabel(type)) %>" />
				</aui:field-wrapper>
			...
			<c:otherwise>
				<aui:field-wrapper label="type" name="roleType">
					<liferay-ui:input-resource id="roleType" url="<%= LanguageUtil.get(pageContext, role.getTypeLabel()) %>" />
				</aui:field-wrapper>
			</c:otherwise>
		</c:choose>
