...
<aui:script>
	...
	Liferay.provide(
		...
		function() {
			...
			document.<portlet:namespace />fm.<portlet:namespace />selectedTargets.value = Liferay.Util.listCheckedExcept(document.<portlet:namespace />fm, "<portlet:namespace />allRowIds");
