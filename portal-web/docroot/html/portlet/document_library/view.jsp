	...
	<aui:row cssClass="lfr-app-column-view">
		...
		<aui:col cssClass="context-pane" width="<%= showFolderMenu ? 75 : 100 %>">
			...
			<div class="<%= cssClass %>" id="<portlet:namespace />showSyncMessageIconContainer">
				<img alt="<liferay-ui:message key="show-liferay-sync-tip" />" class="show-sync-message" id="<portlet:namespace />showSyncMessageIcon" src="<%= themeDisplay.getPathThemeImages() + "/common/liferay_sync.png" %>" title="<liferay-ui:message key="liferay-sync" />" />
			</div>
