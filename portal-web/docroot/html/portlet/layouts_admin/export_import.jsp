							...
							new Liferay.Upload(
								{
									...
									strings: {
										...
										pendingFileText: '<liferay-ui:message key="this-file-has-been-previously-uploaded-but-not-actually-imported" />'
									},
									tempFileURL: {
...
<aui:script use="aui-base,aui-loading-mask,json-stringify,aui-io-plugin">
