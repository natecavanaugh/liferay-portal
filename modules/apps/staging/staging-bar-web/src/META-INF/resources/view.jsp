...
<c:if test="<%= themeDisplay.isShowStagingIcon() %>">
	...
	<c:if test="<%= (liveGroup != null) %>">
		<c:choose>
			<c:when test="<%= group.isStagingGroup() || group.isStagedRemotely() %>">
				<c:if test="<%= stagingGroup != null %>">
					<aui:nav-item anchorCssClass="staging-link" cssClass="active site-variations staging-toggle" id="stagingLink" label="staging" toggle="<%= true %>" />
		...
		<c:choose>
			...
			<c:otherwise>
				<aui:nav-item anchorCssClass="staging-link" cssClass="active live-link staging-toggle" id="liveLink" label="live" toggle="<%= true %>" />
